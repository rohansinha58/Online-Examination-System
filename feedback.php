...
<title>CAMPUS HIRING || FEEDBACK </title>
...
<div class="col-lg-6">
<span class="logo">TCL CSOT CAMPUS HIRING</span></div>
<div class="col-md-2">
</div>
<div class="col-md-4">
<?php
...
<div class="col-md-10">
<a href="mailto:" style="color:#000000">rohan@tcl.com</a><br /><br />
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/dev.jpg" width=100 height=100 alt="Rohan Kumar Sinha" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="https://www.linkedin.com/in/rohansinha58/" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Rohan Sinha</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 7091141248</h4>
		<h4 style="font-family:'typo' ">rohan@tcl.com</h4>
		<h4 style="font-family:'typo' ">Machine Automation Engineer, TCL CSOT</h4></div></div>
		</p>
      </div>
